...
class RuntimePlan:
    ...
    def build_from_graphs(self, graphs: list[Subgraph], pending_priorities: dict[str, PriorityBand] | None = None) -> None:
    ...
    def get_node_priority(self, node_name: str) -> PriorityBand:
        ...
        if ready_state.message_ready:
            ...
            return max(
                (edge_ref.priority_band for edge_ref in node_ref.inputs.values() 
