...
class TestPrometheusMetrics:
    ...
    def test_metric_naming_with_namespace(self) -> None:
        ...
        counter = metrics.counter("messages_total", {"node": "test"})
    ...
    def test_metric_key_generation(self) -> None:
        ...
        counter2 = metrics.counter("requests", {"method": "POST", "status": "201"})
        counter3 = metrics.counter("requests", {"method": "GET", "status": "200"})  # Same as counter1
